# Registro de Produção — Quem é o Maranhão?
...
## Fase 1 — Verbetes-Âncora (8 verbetes)
...
|---|---------|------|--------|----------|------|
| V01 | Coordenadas: onde fica o Maranhão | Verbete-mapa | ⏳ Pendente | — | — |
...
### PARTE II — OS PRIMEIROS (8 verbetes)
...
### PARTE III — A CONQUISTA (8 verbetes)
...
### PARTE IV — O POVO NEGRO (10 verbetes)
...
### PARTE V — APOGEU E QUEDA (8 verbetes)
...
### PARTE VI — SÃO LUÍS: A ILHA (9 verbetes)
...
### PARTE VII — O POVO E A IDENTIDADE (9 verbetes)
...
### PARTE VIII — AS CRIAÇÕES (16 verbetes)
...
### PARTE IX — A ECONOMIA (10 verbetes)
...
### PARTE X — O ESTADO E A ESTRUTURA (8 verbetes)
...
### PARTE XI — O MARANHÃO NO MUNDO (6 verbetes)
...
| # | Verbete | Tipo | Status | Palavras | Data |
|---|---------|------|--------|----------|------|
| V106 | Quem é o Maranhão? — ensaio-epílogo | Ensaio literário | ⏳ Pendente | — | — |
...
| ID | Verbete | Duração | Formato | Título |
|----|---------|---------|---------|--------|
...
| ID | Verbete | Tipo | Posição | Descrição |
|----|---------|------|---------|-----------|
...
*Registro de produção — atualizado a cada verbete concluído.*
*Referência: coordination-v3.md | playbook-v2.md*
