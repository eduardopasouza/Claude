...
export type LayerConfig = {
  ...
  source?: string;
  /** Ano default para camadas temporais (ex: choropleth IBGE) */
  defaultYear?: number;
  /** Escala de cor (viridis, ylorrd, etc) para choropleth */
  colorScheme?: "viridis" | "YlGn" | "YlOrBr" | "YlGnBu" | "Greens" | "Reds" | "Blues" | "Greys" | "Oranges" | "Purples" | "PuRd" | "BuPu" | "BuGn" | "OrRd";
};
...
export const LAYERS: LayerConfig[] = [
  ...
  // ============== PREÇO ATUAL POR UF (Agrolink) (10) ==============
  ...
  { id: "preco_cana_uf", name: "Preço Cana-de-açúcar por UF", description: "R$/ton — Agrolink", category: "producao_ibge", color: "#84CC16", endpoint: "ibge_choropleth_uf", endpointId: "preco_cana", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "Greens" },
  { id: "preco_algodao_uf", name: "Preço Algodão (pluma) por UF", description: "R$/@ — Agrolink", category: "producao_ibge", color: "#F3F4F6", endpoint: "ibge_choropleth_uf", endpointId: "preco_algodao", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "BuPu" },
  { id: "preco_acucar_uf", name: "Preço Açúcar VHP por UF", description: "R$/sc 50kg — Agrolink", category: "producao_ibge", color: "#FEF3C7", endpoint: "ibge_choropleth_uf", endpointId: "preco_acucar", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "YlGnBu" },
  { id: "preco_sorgo_uf", name: "Preço Sorgo por UF", description: "R$/sc 60kg — Agrolink", category: "producao_ibge", color: "#A16207", endpoint: "ibge_choropleth_uf", endpointId: "preco_sorgo", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "Oranges" },
  ...
  { id: "preco_frango_uf", name: "Preço Frango por UF", description: "R$/kg — Agrolink", category: "pecuaria_ibge", color: "#FBBF24", endpoint: "ibge_choropleth_uf", endpointId: "preco_frango", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "Oranges" },
  { id: "preco_leite_uf", name: "Preço Leite por UF (Agrolink)", description: "R$/litro ao produtor — Agrolink", category: "pecuaria_ibge", color: "#FB7185", endpoint: "ibge_choropleth_uf", endpointId: "preco_leite", minZoom: 3, maxFeatures: 27, geometryType: "choropleth", source: "Agrolink", colorScheme: "BuGn" },
  ...
  { id: "ibge_pam_cafe", name: "Produção Café", description: "IBGE PAM — ton", category: "producao_ibge", color: "#78350F", endpoint: "ibge_choropleth", endpointId: "pam_cafe", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "PuRd" },
  { id: "ibge_pam_algodao", name: "Produção Algodão", description: "IBGE PAM — ton", category: "producao_ibge", color: "#F3F4F6", endpoint: "ibge_choropleth", endpointId: "pam_algodao", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "BuPu" },
  { id: "ibge_pam_arroz", name: "Produção Arroz", description: "IBGE PAM — ton", category: "producao_ibge", color: "#FEF3C7", endpoint: "ibge_choropleth", endpointId: "pam_arroz", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "YlGnBu" },
  { id: "ibge_pam_feijao", name: "Produção Feijão", description: "IBGE PAM — ton", category: "producao_ibge", color: "#A16207", endpoint: "ibge_choropleth", endpointId: "pam_feijao", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "Oranges" },
  { id: "ibge_pam_trigo", name: "Produção Trigo", description: "IBGE PAM — ton", category: "producao_ibge", color: "#D97706", endpoint: "ibge_choropleth", endpointId: "pam_trigo", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "OrRd" },
  { id: "ibge_pam_area_soja", name: "Área Colhida Soja", description: "Hectares colhidos de soja por município", category: "producao_ibge", color: "#65A30D", endpoint: "ibge_choropleth", endpointId: "pam_area_soja", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "YlGn" },
  { id: "ibge_pam_valor_soja", name: "Valor Produção Soja", description: "R$ mil por município — IBGE PAM", category: "producao_ibge", color: "#84CC16", endpoint: "ibge_choropleth", endpointId: "pam_valor_soja", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "YlGn" },

  // ============== PECUÁRIA IBGE (choropleth via SIDRA t.3939) (4) ==============
  { id: "ibge_ppm_bovino", name: "Rebanho Bovino (IBGE PPM)", description: "Efetivo bovino por município — Tabela 3939", category: "pecuaria_ibge", color: "#BE123C", endpoint: "ibge_choropleth", endpointId: "ppm_bovinos", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA PPM", defaultYear: 2022, colorScheme: "Reds" },
  { id: "ibge_ppm_ovino", name: "Rebanho Ovino", description: "IBGE PPM 3939", category: "pecuaria_ibge", color: "#E11D48", endpoint: "ibge_choropleth", endpointId: "ppm_ovinos", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "Purples" },
  { id: "ibge_ppm_suino", name: "Rebanho Suíno", description: "IBGE PPM 3939", category: "pecuaria_ibge", color: "#F43F5E", endpoint: "ibge_choropleth", endpointId: "ppm_suinos", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "Reds" },
  { id: "ibge_ppm_bubalinos", name: "Rebanho Bubalino", description: "IBGE PPM 3939", category: "pecuaria_ibge", color: "#FB7185", endpoint: "ibge_choropleth", endpointId: "ppm_bubalinos", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2022, colorScheme: "BuGn" },
  ...
  { id: "ibge_pib_municipal", name: "PIB Total Municipal", description: "IBGE SIDRA 5938 — R$ mil", category: "socioeconomico", color: "#A78BFA", endpoint: "ibge_choropleth", endpointId: "pib_total", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2021, colorScheme: "Blues" },
  { id: "ibge_pib_per_capita", name: "PIB per capita", description: "IBGE SIDRA 5938 — R$ per capita", category: "socioeconomico", color: "#7C3AED", endpoint: "ibge_choropleth", endpointId: "pib_per_capita", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2021, colorScheme: "YlGnBu" },
  { id: "ibge_populacao", name: "População Estimada", description: "IBGE SIDRA 6579 — habitantes", category: "socioeconomico", color: "#C084FC", endpoint: "ibge_choropleth", endpointId: "populacao", minZoom: 4, maxFeatures: 5570, geometryType: "choropleth", source: "IBGE SIDRA", defaultYear: 2021, colorScheme: "Greys" },
