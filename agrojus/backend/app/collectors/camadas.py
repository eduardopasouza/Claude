...
LAYER_CATALOG = {
    ...
    "car_imoveis": {
        "name": "Imoveis CAR (Nacional)",
        "category": "fundiario",
        "source": "SICAR/MMA",
        "wfs_url": "https://geoserver.car.gov.br/geoserver/sicar/wfs",
        "layer_name": "sicar:sicar_imoveis_{uf}",
        "postgis_table": "geo_car",
        "format": "PostGIS/GeoJSON",
        "auth_required": False,
        "status": "active",
        "ssl_note": "Requer SSL SECLEVEL=1",
        "description": "Imoveis rurais cadastrados no CAR com poligonos — 27 estados via WFS",
    },
    "terras_uniao": {
    ...
    "unidades_conservacao": {
        "name": "Unidades de Conservacao (ICMBio)",
        "category": "ambiental",
        "source": "ICMBio/MMA",
        "wfs_url": "https://geoservicos.inde.gov.br/geoserver/ICMBio/ows",
        "layer_name": "ICMBio:limiteucsfederais_a",
        "postgis_table": "geo_unidades_conservacao",
        "format": "PostGIS/GeoJSON",
        "auth_required": False,
        "status": "active",
        "total_records": 346,
        "description": "346 UCs federais (parques nacionais, APAs, reservas biologicas)",
    },
    "embargos_icmbio": {
        ...
        "postgis_table": "geo_embargos_icmbio",
        "format": "PostGIS/GeoJSON",
        "auth_required": False,
        "status": "active",
        "total_records": 5000,
        "description": "Embargos em Unidades de Conservacao federais",
    },
    "autos_icmbio": {
        "name": "Autos de Infracao ICMBio",
        "category": "ambiental",
        "source": "ICMBio/INDE",
        "wfs_url": "https://geoservicos.inde.gov.br/geoserver/ICMBio/ows",
        "layer_name": "ICMBio:autos_infracao_icmbio",
        "postgis_table": "geo_autos_icmbio",
        "format": "PostGIS/GeoJSON",
        "auth_required": False,
        "status": "active",
        "total_records": 10000,
        "description": "Autos de infracao ambiental em UCs federais",
    },
    "prodes": {
        "name": "PRODES Desmatamento Anual",
        "category": "ambiental",
        "source": "INPE/TerraBrasilis",
        "wfs_url": "https://terrabrasilis.dpi.inpe.br/geoserver/prodes-legal-amz/ows",
        "layer_name": "prodes-legal-amz:accumulated_deforestation_2007",
        "postgis_table": "geo_prodes",
        "format": "PostGIS/GeoJSON",
        "auth_required": False,
        "status": "active",
        "total_records": 50000,
        "description": "Desmatamento anual consolidado — essencial MCR 2.9 (corte 2019)",
    },
    "biomas": {
